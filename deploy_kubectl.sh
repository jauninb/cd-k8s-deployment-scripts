...
cat deployment.yml
kubectl apply -f deployment.yml --namespace ${CLUSTER_NAMESPACE:-"default"}
echo ""
echo "DEPLOYED SERVICE:"
kubectl describe services hello-service --namespace ${CLUSTER_NAMESPACE:-"default"}
echo ""
echo "DEPLOYED PODS:"
kubectl describe pods --selector app=hello-app --namespace ${CLUSTER_NAMESPACE:-"default"}
PORT=$( kubectl get services --namespace ${CLUSTER_NAMESPACE:-"default"} | grep hello-service | sed 's/.*:\([0-9]*\).*/\1/g' )
echo ""
